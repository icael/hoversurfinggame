...
Player = game.Class.extend({
    ...
    init: function() {
        ...
        var shape = new game.Rectangle(80+4,50+8-12);
    ...
    update: function() {
        ...
        this.smokeEmitter.position.y = this.sprite.position.y + 30;

        this.flyEmitter.target.x = this.sprite.position.x + 20;
        this.flyEmitter.target.y = this.sprite.position.y - 35;
    },
